...
const blockchainEndpoint = process.env.REACT_APP_BLOCKCHAIN_ENDPOINT || 'http://127.0.0.1:8888'  
const rpc = new JsonRpc(blockchainEndpoint); // nodeos and web server are on same port
        ...
        this.interval = window.setInterval(async () => {
            try {
                const rows = await rpc.get_table_rows({
                    json: true, code: 'useraaaaaaaa', scope: '', table: 'message', limit: 1000,
                });
                let content =
